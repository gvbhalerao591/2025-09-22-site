...
address: "Weston Library, Broad Street, Oxford"      # full street address of workshop (e.g., "Room A, 123 Forth Street, Blimingen, Euphoria"), videoconferencing URL, or 'online'
...
instructor: ["Daniel Valdenegro", "Mcebisi Ntleki", "Tom Russell", "Gaurav Bhalerao"] # boxed, comma-separated list of instructors' names as strings, like ["Kay McNulty", "Betty Jennings", "Betty Snyder"]
helper: ["David Hemprich-Bennett", "Sara Perez Vizan", "Hieu Thai", "Jo Gay", "Broncio Aguilar Sanjuan", "Elisabeth Rothweiler", "Becky Im"]     # boxed, comma-separated list of helpers' names, like ["Marlyn Wescoff", "Fran Bilas", "Ruth Lichterman"]
email: ["alice.little@admin.ox.ac.uk","gaurav.bhalerao@ndcn.ox.ac.uk"]    # boxed, comma-separated list of contact email addresses for the host, lead instructor, or whoever else is handling questions, like ["marlyn.wescoff@example.org", "fran.bilas@example.org", "ruth.lichterman@example.org"]
